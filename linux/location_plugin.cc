#include "include/location_plugin/location_plugin.h"
...
#include "location_plugin_private.h"
...
static void location_plugin_handle_method_call(
    LocationPlugin* self,
...
static void method_call_cb(FlMethodChannel* channel, FlMethodCall* method_call,
                           gpointer user_data) {
  LocationPlugin* plugin = LOCATION_PLUGIN(user_data);
  location_plugin_handle_method_call(plugin, method_call);
}

void location_plugin_register_with_registrar(FlPluginRegistrar* registrar) {
  LocationPlugin* plugin = LOCATION_PLUGIN(
      g_object_new(location_plugin_get_type(), nullptr));
